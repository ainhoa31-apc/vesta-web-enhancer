...
import vestaCss from "../vesta.css?url";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Vesta Marketing Inmobiliario" },
      ...
      { name: "application-name", content: "vesta-marketing-inmobiliario" },
      { name: "apple-mobile-web-app-title", content: "vesta-marketing-inmobiliario" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Vesta Marketing Inmobiliario" },
      { name: "twitter:site", content: "@vestamarketing_" },
      { name: "google-site-verification", content: "GOwzs_CLQpDF2TsIj-c_BHyHZ1q8Z3fhHptXlKMPbYQ" },
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;1,500&family=Playfair+Display:ital,wght@0,500;0,600;0,700;1,500&family=Jost:wght@300;400;500;600&display=swap",
      },
